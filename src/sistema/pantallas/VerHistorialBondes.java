 ...
 * @author ALBER
 */
public class VerHistorialBondes extends javax.swing.JFrame {
     ...
     */
    public VerHistorialBondes(Sistema sistem, int id, int quies) {
        initComponents();
        this.sistem = sistem;
        this.id = id;
        this.quies = quies;
    ...
    public void Despliega(){
        ...
        while(itr.hasNext()){
            ...
            if( quies == 3 ){
                ...
                rowData[7] = bon.getComisionCasa();
                rowData[8] = bon.getComisionPromotor();
